// Similar Triangles: Scale Factor Visualization
// Shows 4 triangles (ABC, DEF, GHI, JKL) to scale with side length ratios
...
function drawTriangle(tri) {
  ...
  // Assuming this is roughly a right triangle for visualization
