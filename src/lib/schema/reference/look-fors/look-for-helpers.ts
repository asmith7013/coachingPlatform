 ...
 */
export function getLookForDescriptionSummary(lookFor: LookFor, maxLength: number = 100): string {
 ...
 */
export function getLookForItemTagsSummary(item: LookForItem, maxTags: number = 3): string {
