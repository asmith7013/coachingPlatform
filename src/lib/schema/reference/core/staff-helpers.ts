...
// Helper Functions
export function getStaffDisplayName(staff: StaffMember | NYCPSStaff | TeachingLabStaff): string {
    return staff.staffName;
  }
  
  export function getStaffRoleDisplay(staff: NYCPSStaff | TeachingLabStaff): string {
