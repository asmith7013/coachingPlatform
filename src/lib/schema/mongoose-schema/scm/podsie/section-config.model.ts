...
const assignmentContentSchema = new mongoose.Schema(
  {
    ...
    subsection: { type: Number, required: false },
...
SectionConfigSchema.index({ school: 1, classSection: 1 }, { unique: true });
...
export const SectionConfigModel = mongoose.model(
  "SectionConfig",
  SectionConfigSchema,
);
