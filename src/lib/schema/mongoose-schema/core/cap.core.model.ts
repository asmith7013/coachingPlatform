...
const WeeklyPlanEmbeddedSchema = new mongoose.Schema(
  ...
  { _id: false },
); // No separate _id for embedded docs
...
const CoachingActionPlanSchema = new mongoose.Schema(
  schemaFields,
  standardSchemaOptions,
);
...
export const CoachingActionPlanModel =
  mongoose.models.CoachingActionPlan ||
