...
const coachingLogFields = {
  ...
  NYCSolvesAdmin: {
    type: String,
    enum: Object.values(NYCSolvesAdminEnum),
    required: false,
  },
  adminDone: {
    type: String,
    enum: Object.values(AdminDoneEnum),
    required: false,
  },
  totalDuration: {
    type: String,
    enum: Object.values(LengthTypeEnum),
    required: true,
  },
  solvesTouchpoint: {
    type: String,
    enum: Object.values(TeacherLeaderTypeEnum),
    required: true,
  },
  ...
  teachersSupportedTypes: [
    { type: String, enum: Object.values(TeacherSupportTypes), default: [] },
  ],
