...
const ClassroomObservationSchema = new mongoose.Schema(
  classroomObservationFields,
  {
    ...standardSchemaOptions,
...
export const ClassroomObservationModel =
  mongoose.models.ClassroomObservation ||
...
const ObservationCriterionSchema = new mongoose.Schema(
  observationCriterionFields,
  {
    ...standardSchemaOptions,
...
export const ObservationCriterionModel =
  mongoose.models.ObservationCriterion ||
...
const feedbackItemFields = {
  ...
  type: {
    type: String,
    enum: ["glow", "wonder", "grow", "nextSteps"],
    required: true,
  },
...
export const FeedbackItemModel =
...
const lessonFlowStepFields = {
  ...
  activity: {
    type: String,
    enum: ["warmUp", "activity1", "activity2", "lessonSynthesis"],
    required: true,
  },
  stepType: {
    type: String,
    enum: ["launch", "workTime", "synthesis"],
    required: true,
  },
...
export const LessonFlowStepModel =
  mongoose.models.LessonFlowStep ||
...
export const LessonFlowNoteModel =
  mongoose.models.LessonFlowNote ||
...
export const LearningTargetModel =
  mongoose.models.LearningTarget ||
...
const ObservationTimeTrackingSchema = new mongoose.Schema(
  observationTimeTrackingFields,
  {
    ...standardSchemaOptions,
...
export const ObservationTimeTrackingModel =
  mongoose.models.ObservationTimeTracking ||
...
export const TranscriptSectionModel =
  mongoose.models.TranscriptSection ||
...
const CustomTranscriptSectionSchema = new mongoose.Schema(
  customTranscriptSectionFields,
  {
    ...standardSchemaOptions,
...
export const CustomTranscriptSectionModel =
  mongoose.models.CustomTranscriptSection ||
...
export const ContextualNoteModel =
  mongoose.models.ContextualNote ||
...
export const ObservationTagModel =
  mongoose.models.ObservationTag ||
...
const ObservationMetadataSchema = new mongoose.Schema(
...
export const ObservationMetadataModel =
  mongoose.models.ObservationMetadata ||
