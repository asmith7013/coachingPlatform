// src/lib/schema/mongoose-schema/313/podsie/worked-example-request.model.ts
...
const workedExampleRequestSchema = new mongoose.Schema({
  ...
  completedWorkedExampleId: {
    type: String,
    required: false,
    description: "MongoDB ObjectId of created worked example deck when completed"
  },
...
workedExampleRequestSchema.index({ scopeSequenceTag: 1, unitNumber: 1, lessonNumber: 1 }); // For filtering by lesson
...
export const WorkedExampleRequestModel = mongoose.models.WorkedExampleRequest || mongoose.model('WorkedExampleRequest', workedExampleRequestSchema);
