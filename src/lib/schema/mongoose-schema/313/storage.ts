...
const SnorklActivitySchema = new mongoose.Schema(
  SnorklActivitySchemaFields, 
  {
...
export const SnorklActivityModel = mongoose.models.SnorklActivity || 
  mongoose.model("SnorklActivity", SnorklActivitySchema);

export const SnorklScrapingMetadataModel = mongoose.models.SnorklScrapingMetadata || 
