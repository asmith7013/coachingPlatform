...
export const UserMetadataZodSchema = z.object({
  ...
  schoolIds: z.array(z.string()).default([]).describe("All associated school IDs"),
  ...
  managedSchools: z.array(z.string()).default([]).describe("Schools this user manages"),
  onboardingCompleted: z.boolean().default(false).describe("Whether onboarding is complete"),
