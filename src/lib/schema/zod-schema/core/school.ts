...
export const SchoolFieldsSchema = z.object({
  ...
  scheduleIds: z
    ...
    .default([])
    .describe(
      "Array of Schedule document _ids for this school's bell schedules",
    ),
  cycleIds: z
    .array(z.string())
    .default([])
    .describe(
      "Array of Cycle document _ids for coaching cycles at this school",
    ),
  yearsOfIMImplementation: z
    .number()
    .min(0)
...
export const SchoolReferenceZodSchema = BaseReferenceZodSchema.merge(
  ...
  gradeLevels: z
    .array(z.string())
    .optional()
    .describe("Supported grade levels summary"),
...
export function createSchoolDefaults(
 ...
 */
export const schoolToReference = createReferenceTransformer<
  School,
  SchoolReference
>(
 ...
 */
export const schoolsToReferences = createArrayTransformer<
  School,
  SchoolReference
>(schoolToReference);
