...
export const QuestionVariationSchema = z.object({
  questionNumber: z
    ...
    .int()
    .positive()
    .describe("Question number (1, 2, 3...)"),
  ...
  contextScenario: z
    .string()
    .optional()
    .describe("Introductory text/scenario (if any)"),
  questionText: z
    .string()
    .describe("The actual question prompt - exactly as student sees it"),
  ...
  visualHtml: z
    .string()
    .optional()
    .describe("Static HTML for table or SVG for graph"),
  visualDescription: z
    .string()
    .optional()
    .describe("Alt text / description of the visual"),

  // Answer information
  acceptanceCriteria: z
    .array(z.string())
    .describe("Conditions for correct response"),
  correctAnswer: z.string().describe("The correct answer"),
  acceptableAnswerForms: z
    .array(z.string())
    .optional()
    .describe("Equivalent forms accepted (e.g., '0.5', '1/2', '50%')"),

  // Explanation for AI tutor / grading
  explanation: z
    .string()
    .describe("Guidance for AI tutor - hints, common misconceptions"),
  solutionSteps: z
    .array(z.string())
    .optional()
    .describe("Step-by-step solution process"),
});
...
export const AssignmentVariationFieldsSchema = z.object({
  ...
  title: z
    .string()
    .describe(
      "Assignment title (e.g., 'Linear Equations Practice - Version B')",
    ),
  ...
  scopeAndSequenceId: z
    .string()
    .optional()
    .describe("MongoDB ObjectId of scope-and-sequence document"),
  section: SectionZod.optional().describe(
  ...
  // =====================================
  originalAssignmentName: z
    .string()
    .optional()
    .describe("Name of the original Podsie assignment"),
  originalPodsieAssignmentId: z
    .string()
    .optional()
    .describe("Podsie assignment UUID if known"),

  // =====================================
  // QUESTIONS
  // =====================================
  questions: z
    .array(QuestionVariationSchema)
...
export const AssignmentVariationZodSchema = BaseDocumentSchema.merge(
  AssignmentVariationFieldsSchema,
);

// Input schema for creation (excludes _id, id, createdAt, updatedAt)
export const AssignmentVariationInputZodSchema = toInputSchema(
  AssignmentVariationZodSchema,
);
...
export type AssignmentVariationInput = z.infer<
  typeof AssignmentVariationInputZodSchema
>;
...
export type AssignmentVariationQuery = z.infer<
  typeof AssignmentVariationQuerySchema
>;
