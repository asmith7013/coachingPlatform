...
const PodsieScmGroupFieldsSchema = z.object({
  ...
  groupName: z.string().nullable().optional().describe("Display name (synced from Podsie)"),
  gradeLevel: ScopeSequenceTagZod.nullable().optional().describe("Grade level for this section"),
