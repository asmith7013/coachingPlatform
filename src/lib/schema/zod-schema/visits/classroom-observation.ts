...
export const ClassroomObservationFieldsSchema = z.object({
  ...
  date: z
    ...
    .describe("ISO date string for user input"),
...
export const ClassroomObservationZodSchema = BaseDocumentSchema.extend(
  ClassroomObservationFieldsSchema.shape,
);
export const ClassroomObservationInputZodSchema = toInputSchema(
  ClassroomObservationZodSchema,
);

export type ClassroomObservation = z.infer<
  typeof ClassroomObservationZodSchema
>;
export type ClassroomObservationInput = z.infer<
  typeof ClassroomObservationInputZodSchema
>;
...
export const ObservationCriterionFieldsSchema = z.object({
  ...
  category: z
    .string()
    .optional()
    .describe("engagement, questioning, facilitation"),
  sortOrder: z.number().default(0).describe("For maintaining order"),
});

export const ObservationCriterionZodSchema = BaseDocumentSchema.merge(
  ObservationCriterionFieldsSchema,
);
export const ObservationCriterionInputZodSchema = toInputSchema(
  ObservationCriterionZodSchema,
);

export type ObservationCriterion = z.infer<
  typeof ObservationCriterionZodSchema
>;
export type ObservationCriterionInput = z.infer<
  typeof ObservationCriterionInputZodSchema
>;
...
export const FeedbackItemZodSchema = BaseDocumentSchema.merge(
  FeedbackItemFieldsSchema,
);
...
export const LessonFlowStepZodSchema = BaseDocumentSchema.merge(
  LessonFlowStepFieldsSchema,
);
export const LessonFlowStepInputZodSchema = toInputSchema(
...
export const LessonFlowNoteZodSchema = BaseDocumentSchema.merge(
  LessonFlowNoteFieldsSchema,
);
export const LessonFlowNoteInputZodSchema = toInputSchema(
...
export const LearningTargetZodSchema = BaseDocumentSchema.merge(
  LearningTargetFieldsSchema,
);
export const LearningTargetInputZodSchema = toInputSchema(
...
export const ObservationTimeTrackingFieldsSchema = z.object({
  observationId: z
    .string()
    .describe("Reference to main observation (should be 1:1)"),
  classStartTime: z.string().default(""),
  classEndTime: z.string().default(""),
  observationStartTime: z
    .string()
    .optional()
    .describe("ISO string for precise timing"),
  observationEndTime: z
    .string()
    .optional()
    .describe("ISO string for precise timing"),
...
export const ObservationTimeTrackingZodSchema = BaseDocumentSchema.merge(
  ObservationTimeTrackingFieldsSchema,
);
export const ObservationTimeTrackingInputZodSchema = toInputSchema(
  ObservationTimeTrackingZodSchema,
);

export type ObservationTimeTracking = z.infer<
  typeof ObservationTimeTrackingZodSchema
>;
export type ObservationTimeTrackingInput = z.infer<
  typeof ObservationTimeTrackingInputZodSchema
>;
...
export const TranscriptSectionZodSchema = BaseDocumentSchema.merge(
  TranscriptSectionFieldsSchema,
);
export const TranscriptSectionInputZodSchema = toInputSchema(
...
export const CustomTranscriptSectionZodSchema = BaseDocumentSchema.merge(
  CustomTranscriptSectionFieldsSchema,
);
export const CustomTranscriptSectionInputZodSchema = toInputSchema(
  CustomTranscriptSectionZodSchema,
);

export type TranscriptSection = z.infer<typeof TranscriptSectionZodSchema>;
export type TranscriptSectionInput = z.infer<
  typeof TranscriptSectionInputZodSchema
>;
export type CustomTranscriptSection = z.infer<
  typeof CustomTranscriptSectionZodSchema
>;
export type CustomTranscriptSectionInput = z.infer<
  typeof CustomTranscriptSectionInputZodSchema
>;
...
export const ContextualNoteFieldsSchema = z.object({
  observationId: z
    .string()
    .optional()
    .describe("Reference to main observation"),
  content: z.string(),
  noteType: z.enum([
    "observation",
    "debrief",
...
export const ContextualNoteZodSchema = BaseDocumentSchema.merge(
  ContextualNoteFieldsSchema,
);
export const ContextualNoteInputZodSchema = toInputSchema(
...
export const ObservationTagZodSchema = BaseDocumentSchema.merge(
  ObservationTagFieldsSchema,
);
export const ObservationTagInputZodSchema = toInputSchema(
...
export const ObservationMetadataFieldsSchema = z.object({
  ...
  lastTagUpdate: z
    .string()
    .optional()
    .describe("ISO string for system timestamp"),
});

export const ObservationMetadataZodSchema = BaseDocumentSchema.merge(
  ObservationMetadataFieldsSchema,
);
export const ObservationMetadataInputZodSchema = toInputSchema(
  ObservationMetadataZodSchema,
);

export type ObservationMetadata = z.infer<typeof ObservationMetadataZodSchema>;
export type ObservationMetadataInput = z.infer<
  typeof ObservationMetadataInputZodSchema
>;
