...
export const responsiveLayoutVariant = tv({
  ...
  variants: {
    ...
    stack: {
      ...
      responsive: {
        container: 'flex flex-col sm:flex-row items-start sm:items-center gap-1 sm:gap-3',
        title: 'mb-1 sm:mb-0 sm:mr-2',
        content: 'w-full sm:w-auto',
      },
      // Reverse responsive: row on mobile, stacked on desktop
      reverse: {
        container: 'flex flex-row sm:flex-col items-center sm:items-start gap-2 sm:gap-1',
...
export type ResponsiveLayoutVariants = VariantProps<typeof responsiveLayoutVariant>;
export type ResponsiveGridVariants = VariantProps<typeof responsiveGridVariant>;
export type ResponsiveSpacingVariants = VariantProps<typeof responsiveSpacingVariant>;
export type IconContentLayoutVariants = VariantProps<typeof iconContentLayoutVariant>;
export type ContainerLayoutVariants = VariantProps<typeof containerLayoutVariant>;
