...
import { 
  ...
  import { ClientDocument } from '@core-types/document';
  import { z } from 'zod';
  ...
  export interface ImportPreview {
    ...
    requiredForFinalValidation?: string[]; // Fields required for the final validation
  }
  ...
  export interface TransformResult extends Pick<BaseResponse, 'success'> {
    ...
    errors: Record<string, string>;
    warnings?: Record<string, string>;
    requiredForFinalValidation?: string[]; // Fields required for final validation
  }
