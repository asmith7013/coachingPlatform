  ...
  return withQueryValidation(querySchema)(
    async (
      ...
      try {
        ...
        const enrichedParams = applySearchFilters(
          validatedParams as QueryParams,
          defaultSearchField,
        );
        ...
        return NextResponse.json(
          createMonitoredErrorResponse("Reference endpoint error", error, {
            component,
...
function applySearchFilters(
  ...
  return {
    ...
    filters: {
      ...params.filters,
      ...createMongoDBFilter(
        params as Required<QueryParams>,
        defaultSearchField,
      ),
    },
  };
...
function logResponse(
  ...
  console.log(
    `📤 ${logPrefix} /${endpoint} response: ${itemCount} items transformed`,
  );
}
