...
export type { NextStep, NextStepInput } from "@zod-schema/look-fors/next-step";
 ...
 */
export function formatLookForDisplay(
  lookFor: Pick<
    import("@zod-schema/look-fors/look-for").LookFor,
    "lookForIndex" | "topic"
  >,
): string {
