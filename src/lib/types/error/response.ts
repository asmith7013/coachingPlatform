...
export type ValidationErrorDetails = z.infer<
  typeof ValidationErrorDetailsZodSchema
>;
export type ValidationErrorResponse = z.infer<
  typeof ValidationErrorResponseZodSchema
>;
export type CollectionErrorResponse<_T = unknown> = z.infer<
  typeof CollectionErrorResponseZodSchema
>;
export type EntityErrorResponse<_T = unknown> = z.infer<
  typeof EntityErrorResponseZodSchema
>;
