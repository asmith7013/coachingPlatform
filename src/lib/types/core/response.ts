 ...
 */
export type CollectionResponse<T = unknown> = Omit<
  z.infer<typeof CollectionResponseZodSchema>,
  "items"
> & {
  items: T[];
  total: number;
 ...
 */
export type EntityResponse<T = unknown> = Omit<
  z.infer<typeof EntityResponseZodSchema>,
  "data"
> & {
  data: T;
};
...
export type PaginatedResponse<T = unknown> = Omit<
  z.infer<typeof PaginatedResponseZodSchema>,
  "items"
> & {
  items: T[];
};
