 ...
 */
export function parseSchoolSlug(
  slug: string,
): { district: string; schoolNumber: string } | null {
 ...
 */
export function createSchoolBreadcrumbLabel(
  schoolNumber: string,
  schoolName: string,
): string {
 ...
 */
export function schoolToSlug(school: {
  district: string;
  schoolNumber: string;
}): string {
 ...
 */
export function schoolToBreadcrumb(school: {
  schoolNumber: string;
  schoolName: string;
}): string {
 ...
 */
export function createValidatedSchoolSlug(
  district: string,
  schoolNumber: string,
): string {
  if (!district?.trim()) {
