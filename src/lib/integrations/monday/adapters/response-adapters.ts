...
import {
  ...
  MondayUser,
} from "@lib/integrations/monday/types/api";

/**
 * Adapts a Monday board response to the standardized entity format
 */
export function adaptMondayBoardResponse(response: {
  boards?: MondayBoard[];
 ...
 */
export function adaptMondayBoardsResponse(response: {
  boards?: MondayBoard[];
 ...
 */
export function adaptMondayItemsResponse(response: {
 ...
 */
export function adaptMondayConnectionTestResponse(response: {
