  ...
  if (error) {
    return (
      <div className="p-8">
        ...
        <Text className="mt-4">Please ensure you have schools in your database.</Text>
      </div>
    );
  }
  ...
  if (!schools || schools.length === 0) {
    return (
      <div className="p-8">
        ...
        <Text className="mt-2">
          You can add schools at: <a href="/dashboard/schoolList" className="text-blue-600 underline">/dashboard/schoolList</a>
        </Text>
      </div>
    );
  }
    ...
    <div>
      <div className="p-4 bg-blue-50 border-b">
        <Text className="text-sm text-blue-700">
          Using first available school: {firstSchool.schoolName} (ID: {firstSchool._id})
        </Text>
      </div>
