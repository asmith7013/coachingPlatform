...
// Schema-first helper: safely format date field according to schema
function formatDateField(date: Date | string | undefined | null): string {
  ...
  if (typeof date === 'string') {
    // If it's already a date string, extract the date part
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div>Date: <code className="bg-gray-100 px-1 rounded">{formatDateField(currentDefaults.date)}</code></div>
          ...
          <Card.Body>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
              ...
              <div>
                ...
                <Input
                  type="date"
                  value={formatDateField(currentDefaults.date)}
                  readOnly
                  className="bg-gray-50"
                />
              </div>
