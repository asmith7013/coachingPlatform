...
/**
 * @deprecated Use `getQuestionMapByName` from `@/app/actions/scm/podsie-question-map` instead.
...
export async function exportCurriculumQuestionMapToDb(
  ...
  try {
    ...
    const { saveQuestionMap } = await import("@/app/actions/scm/podsie-question-map");
