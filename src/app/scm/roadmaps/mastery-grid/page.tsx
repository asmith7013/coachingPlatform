    ...
    <div className="min-h-screen bg-gray-50">
      <div className="mx-auto p-6" style={{ maxWidth: "1600px" }}>
        ...
        <div className="flex gap-6">
          ...
          <div
            className={`${studentGridView ? "w-20" : "w-2/5"} bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden transition-all duration-300`}
          >
            <div className="sticky top-0 bg-gray-50 border-b border-gray-200 px-4 py-3 z-10">
              <h3
                className={`font-semibold text-gray-900 ${studentGridView ? "text-center text-xs" : ""}`}
              >
            ...
            <div className="overflow-y-auto">
              {filteredUnits.length === 0 ? (
                <div
                  className={`p-8 text-center text-gray-500 ${studentGridView ? "p-4" : ""}`}
                >
                  {selectedGrade === "" ? (
                    <>
          ...
          <div
            className={`${studentGridView ? "w-[calc(100%-5rem-1.5rem)]" : "w-3/5"} transition-all duration-300`}
          >
            {studentGridView && selectedSection ? (
              ...
              <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-12 text-center">
                ...
                <div className="text-gray-600">
                  {!selectedSection
                    ? "Select a class section to view mastery grid"
                    : "Select a unit to view mastery grid"}
                </div>
              </div>
            )}
          </div>
