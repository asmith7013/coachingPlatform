...
export function UnitListItem({ unit, isSelected, onClick, compact = false }: UnitListItemProps) {
    ...
    >
      ...
      <div className="mb-2">
        <div className="flex items-center gap-2 mb-2">
          ...
          <div className={`font-medium text-base ${isSelected ? 'text-gray-900' : 'text-gray-900'}`}>
            {cleanTitle}
          </div>
        </div>
      </div>
