...
export function SkillListItem({
  ...
  return (
    ...
    >
      {/* Skill Number */}
      <div
        className={`text-2xl font-bold mb-2 ${isSelected ? "text-blue-700" : "text-blue-600"}`}
      >
        {skill.skillNumber}
      </div>
      ...
      {/* Skill Title */}
      <div
        className={`text-sm font-medium line-clamp-2 ${isSelected ? "text-blue-900" : "text-gray-900"}`}
      >
        {skill.title}
      </div>
