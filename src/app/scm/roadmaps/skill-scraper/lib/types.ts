...
export type RoadmapsScrapingRequest = z.infer<
  typeof RoadmapsScrapingRequestZodSchema
>;
export type RoadmapsScrapingResponse = z.infer<
  typeof RoadmapsScrapingResponseZodSchema
>;
...
export const ROADMAPS_CONSTANTS = {
  ...
  SELECTORS: {
    ...
    SKILL_CRITERIA_FIELDSET:
      'fieldset:has(legend:contains("Skill Challenge Criteria"))',
    ESSENTIAL_QUESTION_FIELDSET:
      'fieldset:has(legend:contains("Essential Question"))',
    ...
    // Video extraction
    ADDITIONAL_LESSONS_ACCORDION:
      'a[aria-controls*="content"]:has-text("Additional Lessons")',
    WORKED_EXAMPLE_VIDEO_LINK:
      'span.cursor-pointer:has-text("Worked Example Video")',
