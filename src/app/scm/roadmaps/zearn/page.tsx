      ...
      <div className="mx-auto p-6" style={{ maxWidth: "1600px" }}>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
          ...
          <ol className="list-decimal list-inside space-y-2 text-blue-800">
            <li>
              Export data from Zearn as a CSV file with the following columns:
            </li>
          </ol>
          <div className="mt-3 p-3 bg-white rounded border border-blue-200 font-mono text-xs text-gray-600 overflow-x-auto">
            School, Class, Class Grade, SIS ID, Last Name, First Name, Student
            Grade, Lesson, Completion Date
          </div>
          <ol
            className="list-decimal list-inside space-y-2 text-blue-800 mt-3"
            start={2}
          >
          ...
          <p className="mt-3 text-sm text-blue-700">
            <strong>Note:</strong> Only unique lessons will be added per
            student. If a student already has a lesson recorded, it will be
            skipped.
          </p>
        </div>
        ...
        <div className="bg-gray-100 rounded-lg p-6">
          ...
          <ul className="text-sm text-gray-600 space-y-1">
            <li>
              <strong>Student not found:</strong> The SIS ID doesn&apos;t match
              any student in the database. Add the student first.
            </li>
            <li>
              <strong>Invalid SIS ID:</strong> The SIS ID must be a number.
            </li>
            <li>
              <strong>Not enough columns:</strong> Ensure your data has all 9
              required columns separated by tabs.
            </li>
          </ul>
        </div>
      </div>
