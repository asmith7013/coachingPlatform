  ...
  return (
    ...
    >
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="mt-2 text-gray-600">
              Automatically scrape assessment data from Roadmaps and update
              student records
            </p>
          </div>
      ...
      <div className="space-y-8">
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 mb-3">
                Automatically scrape all 8 sections (9 total configurations
                including 802&apos;s dual roadmaps) with a single login. This
                will process: 603/605, 604, 704, 703/705, 802 (Algebra 1 + 8th
                Grade), 803, 804, 805.
              </p>
              <ul className="text-sm text-gray-600 space-y-1">
                <li>✅ One login, multiple scrapes</li>
                <li>
                  ✅ Section 802 automatically scrapes both Algebra 1 and 8th
                  Grade
                </li>
                <li>
                  ✅ Automatically updates MongoDB with all assessment data
                </li>
        ...
        <AssessmentScraperForm onSubmit={handleSubmit} isLoading={isLoading} />
          ...
          <div className="space-y-4">
            <div>
              ...
              <ol className="text-sm text-gray-600 space-y-2 list-decimal list-inside">
                ...
                <li>
                  Updates MongoDB with attempt history, mastery dates, and best
                  scores
                </li>
              </ol>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-gray-600 space-y-1">
                <li>
                  • <strong>All attempts</strong> for each skill (attempt #,
                  date, score, pass/fail)
                </li>
                <li>
                  • <strong>Best score</strong> achieved across all attempts
                </li>
                <li>
                  • <strong>Mastery date</strong> - when student first passed
                  (≥80%)
                </li>
                <li>
                  • <strong>Attempt count</strong> and last attempt date
                </li>
                <li>
                  • <strong>Current status</strong> - Mastered, Attempted But
                  Not Mastered, or Not Started
                </li>
              </ul>
            </div>
            ...
            <div className="pt-4 border-t border-gray-200">
              <p className="text-sm text-gray-600">
                <strong>Note:</strong> This scraper uses headless browser
                automation and may take several minutes depending on the amount
                of data.
              </p>
            </div>
          </div>
