...
export function ModelsAndManipulativesSection({
  primerHtml,
}: ModelsAndManipulativesSectionProps) {
  ...
  h4Elements.forEach((h4) => {
    ...
    if (
      sectionsToHide.some((section) => headerText.includes(section)) ||
      headerText.includes("Models and Manipulatives")
    ) {
