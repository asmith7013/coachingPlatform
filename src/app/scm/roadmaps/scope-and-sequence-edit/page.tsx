    ...
    try {
      ...
      if (response.success && response.items) {
        const sorted = response.items.sort(
          (a: ScopeAndSequenceEntry, b: ScopeAndSequenceEntry) => {
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="mx-auto p-6" style={{ maxWidth: "1600px" }}>
        ...
        <div className="mb-6 flex justify-between items-start">
          <div>
            <h1 className="text-3xl font-bold mb-2">Edit Scope and Sequence</h1>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          ...
          <div className="mt-4 text-sm text-gray-600">
            Showing <strong>{filteredLessons.length}</strong> of{" "}
