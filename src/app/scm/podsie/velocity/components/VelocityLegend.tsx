  ...
  return (
    <div className="bg-white rounded-lg shadow p-4 mt-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 text-sm">
        ...
        <div className="flex items-center gap-2">
          <span className="text-xs px-2 py-1 bg-blue-500 text-white rounded font-bold">3</span>
          <span>Lesson completions</span>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-xs px-2 py-1 bg-orange-500 text-white rounded font-bold">2</span>
          <span>Ramp Up completions</span>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-xs px-2 py-1 bg-gray-700 text-white rounded font-bold">•</span>
