...
export default function PresentationsList() {
  ...
  const handleGradeChange = (newGrade: string) => {
    ...
    router.push(`/scm/workedExamples/viewer${params.toString() ? `?${params.toString()}` : ''}`, { scroll: false });
  };
  ...
  const handleOpenPresentation = (slug: string) => {
    ...
    router.push(`/scm/workedExamples/viewer?${params.toString()}`, { scroll: false });
  };
  ...
  const handleSlideChange = (slideIndex: number) => {
    ...
    router.replace(`/scm/workedExamples/viewer?${params.toString()}`, { scroll: false });
  };
