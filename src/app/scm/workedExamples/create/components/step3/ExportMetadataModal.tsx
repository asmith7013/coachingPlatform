    ...
    <div className="fixed inset-0 z-[10001] flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-lg shadow-xl max-w-lg w-full mx-4 p-6">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900">Export to Slides</h3>
            <p className="text-sm text-gray-500">Review deck metadata before exporting</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => setFormData({ ...formData, gradeLevel: e.target.value as GradeLevel || null })}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
            >
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => setFormData({ ...formData, unitNumber: e.target.value ? parseInt(e.target.value) : null })}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                placeholder="e.g., 4"
                min="1"
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setFormData({ ...formData, lessonNumber: e.target.value ? parseInt(e.target.value) : null })}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                placeholder="e.g., 2"
              />
            </div>
          ...
          {/* Math Standard */}
          <div>
            <label htmlFor="mathStandard" className="block text-sm font-medium text-gray-700 mb-1">
              Math Standard
            </label>
            <input
              id="mathStandard"
              ...
              onChange={(e) => setFormData({ ...formData, mathStandard: e.target.value })}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
