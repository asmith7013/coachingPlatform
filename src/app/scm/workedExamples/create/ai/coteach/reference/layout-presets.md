...
| --------------- | ------------------------ | -------------------------------------------------------- |
| **Title Zone**  | Badge + Title + Subtitle | See `card-patterns/simple-patterns/title-zone.html`      |
| **Content Box** | Any text content         | See `card-patterns/simple-patterns/content-box.html`     |
| **SVG Card**    | Graphs/diagrams          | See `card-patterns/complex-patterns/graph-snippet.html`  |
| **CFU/Answer**  | Overlay boxes (animated) | See `card-patterns/simple-patterns/cfu-answer-card.html` |
...
>
  <svg
    viewBox="0 0 520 360"
    style="width: 100%; height: 360px; max-height: 360px;"
  >
    <!-- Graph content -->
  </svg>
</div>
...
See `card-patterns/simple-patterns/content-box.html` for complete patterns.
