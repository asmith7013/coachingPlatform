...
export function SimplifiedUnitView({
  ...
  return (
    <div className="bg-white rounded-lg shadow overflow-hidden border-l-4 border-gray-400">
      {/* Unit Header */}
      <div className="px-4 py-3 font-semibold text-sm flex items-center justify-between bg-gray-100 text-gray-700">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="text-xs px-2 py-1 rounded border border-gray-300 bg-white/50 text-gray-600"
          ...
          return (
            ...
            >
              ...
              <div
                ...
                style={{ backgroundColor: color.light, borderLeft: `3px solid ${color.base}` }}
              >
              ...
              <div className="px-4 py-2" style={{ borderLeft: `3px solid ${color.border}` }}>
                {/* Lessons */}
