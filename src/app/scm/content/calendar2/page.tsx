...
import { SubsectionsModal } from "../calendar/components/SubsectionsModal";
import { useCalendarPageData, type SavedUnitSchedule } from "../calendar/hooks/useCalendarPageData";
import { SimplifiedUnitView } from "./components/SimplifiedUnitView";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex h-[calc(100vh-80px)]">
        ...
        <div className="w-2/3 p-4 overflow-y-auto bg-gray-100 relative">
          ...
          {/* Legend - show selected unit color */}
          <div className="bg-white rounded-lg shadow p-3 mt-4">
            ...
            <div className="flex flex-wrap gap-3 text-xs">
              ...
              {unitSchedules.map((unit, index) => (
                <div key={unit.unitKey} className="flex items-center gap-1">
                  <div
