    ...
    <div className="mx-auto" style={{ maxWidth: "1600px" }}>
      <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
        <div className="flex items-center gap-3 mb-2">
          <TruckIcon className="w-10 h-10 text-amber-600 flex-shrink-0" />
          <h1 className="text-4xl font-bold text-gray-900">Logistics</h1>
        </div>
        <p className="text-gray-600">
          School calendars, scheduling, and operational tools
        </p>
      </div>
