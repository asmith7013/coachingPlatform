...
const unitColors = [
  ...
  { bg: "bg-cyan-50", border: "border-cyan-200", text: "text-cyan-700", badge: "bg-cyan-500" },
  ...
  { bg: "bg-lime-50", border: "border-lime-200", text: "text-lime-700", badge: "bg-lime-500" },
  { bg: "bg-violet-50", border: "border-violet-200", text: "text-violet-700", badge: "bg-violet-500" },
];

export function LessonsTable({ units, skillMap, totalLessons }: LessonsTableProps) {
  ...
  return (
    <div className="space-y-3">
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className={`text-base font-semibold ${color.text} text-left`}>
                    {unit.unitName}
                  </h2>
                </div>
                <div className="flex items-center gap-3">
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {unit.lessons.map((lesson, lessonIndex) => {
                      const sectionStyle = sectionConfig[lesson.section || ""] || { bg: "bg-gray-50", text: "text-gray-700" };
                      ...
                      return (
                        ...
                        >
                          ...
                          {/* Section */}
                          <td className="px-4 py-3 align-top">
                            <span className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${sectionStyle.bg} ${sectionStyle.text}`}>
                              {lesson.section || "-"}
                            </span>
                          </td>
      ...
      <div className="text-sm text-gray-500 text-center py-2">
        {totalLessons} {totalLessons === 1 ? "lesson" : "lessons"} total across {units.length} units
      </div>
    </div>
  );
}
