    ...
    <div className="max-w-6xl mx-auto p-6 space-y-12">
      <div>
        ...
        <p className="text-gray-600 mb-8">
          Demonstrating the simplified API with automatic icon display and clean
          variants.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          <p className="text-sm text-gray-600">
            <strong>API:</strong> Just provide{" "}
            <code>icon={`{CalendarIcon}`}</code> - defaults to colored style!
          </p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          <p className="text-sm text-gray-600">
            Search value: &ldquo;{searchValue1}&rdquo; | <strong>API:</strong>{" "}
            Add <code>iconVariant=&quot;neutral&quot;</code> for subtle style
          </p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          <p className="text-sm text-gray-600">
            <strong>API:</strong> <code>variant=&quot;compact&quot;</code> +{" "}
            <code>icon={`{DocumentTextIcon}`}</code> = smaller colored icon
          </p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          <p className="text-sm text-gray-600">
            <strong>API:</strong> <code>variant=&quot;compact&quot;</code> +{" "}
            <code>iconVariant=&quot;neutral&quot;</code> = smaller neutral icon
          </p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          <p className="text-sm text-gray-600">
            Search value: &ldquo;{searchValue2}&rdquo; | Mixed search + button
            actions with neutral icon
          </p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <h2 className="text-lg font-semibold text-gray-800">
          Search with Sort and Colored Icon
        </h2>
        <SectionHeading
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          <p className="text-sm text-gray-600">
            Search value: &ldquo;{searchValue3}&rdquo; | <strong>API:</strong>{" "}
            Icon defaults to colored when no iconVariant specified
          </p>
        </div>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
        ...
        <div className="space-y-3 text-sm text-blue-800">
          <div>
            <strong>Want an icon?</strong> → <code>icon={`{SomeIcon}`}</code>{" "}
            (defaults to colored)
          </div>
          <div>
            <strong>Want neutral style?</strong> →{" "}
            <code>iconVariant=&quot;neutral&quot;</code>
          </div>
          <div>
            <strong>No icon?</strong> → Don&apos;t provide the icon prop
          </div>
          <div>
            <strong>Compact size?</strong> →{" "}
            <code>variant=&quot;compact&quot;</code>
          </div>
          <div>
            <strong>Subtitle?</strong> →{" "}
            <code>subtitle=&quot;Some text&quot;</code>
          </div>
        </div>
        <p className="text-blue-700 mt-4 font-medium">
          Much cleaner than the old <code>iconVariant=&quot;none&quot;</code>{" "}
          complexity!
        </p>
      </div>
    </div>
