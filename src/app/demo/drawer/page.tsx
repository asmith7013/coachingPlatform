                ...
                {(['sm', 'md', 'lg', 'full'] as const).map((sizeOption) => (
                  <label key={sizeOption} className="flex items-center">
                    <input
                      ...
                      onChange={(e) => setSize(e.target.value as typeof sizeOption)}
                      className="mr-2"
                    />
          ...
          <div className="space-y-6">
            <div>
              <Text textSize="base" className="mb-2">
                This is a demo of the Drawer component with the following configuration:
              </Text>
            ...
            <div className="border-t pt-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    <Text textSize="sm" className="font-medium">User Profile</Text>
                    <Text textSize="xs" color="muted">Manage your account settings</Text>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    <Text textSize="sm" className="font-medium">Settings</Text>
                    <Text textSize="xs" color="muted">Configure application preferences</Text>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    <Text textSize="sm" className="font-medium">Documentation</Text>
                    <Text textSize="xs" color="muted">View component documentation</Text>
                  </div>
                </div>
              </div>
            </div>
