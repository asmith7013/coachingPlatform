  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <Text className="mb-8">
        ...
        The component has been simplified and now integrates with TanStack Form
        through useFieldRenderer. Open your browser console to see detailed
        debug information.
      </Text>
      ...
      <div className="mt-8">
        <Card className="p-4">
          ...
          <Text className="mb-2">
            Single Select Value: {singleValue || "<none>"}
          </Text>
          <Text className="mb-2">
            Integration: ReferenceSelect now works through useFieldRenderer
          </Text>
        </Card>
      </div>
    </div>
