  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <h1 className="text-2xl font-bold mb-2">
        Render Loop Root Cause Analysis
      </h1>
      <p className="mb-6 text-gray-600">
        This page helps identify the fundamental cause of render loops in your
        application
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div className="p-5 bg-white rounded shadow">
          ...
          <ul className="space-y-2">
            <li className="p-3 bg-blue-50 rounded">
              ...
              {showDetails && (
                <p className="mt-1 text-sm">
                  The RenderLoopDetector or other debugging components might
                  have missing dependencies in their useEffect hooks, causing
                  infinite updates.
                </p>
              )}
            </li>
            ...
            <li className="p-3 bg-blue-50 rounded">
              ...
              {showDetails && (
                <p className="mt-1 text-sm">
                  Performance tracking code might update state based on render
                  counts, creating a circular dependency.
                </p>
              )}
            </li>
            ...
            <li className="p-3 bg-blue-50 rounded">
              ...
              {showDetails && (
                <p className="mt-1 text-sm">
                  React&apos;s Strict Mode intentionally double-renders
                  components in development. This is normal and helps find bugs,
                  but can look like a render loop.
                </p>
              )}
            </li>
          </ul>
        ...
        <div className="p-5 bg-white rounded shadow">
          ...
          <div className="space-y-3">
            <Link
              href="/debug/no-debug-tools"
              className="block p-3 bg-green-50 rounded hover:bg-green-100"
            >
      ...
      <div className="p-5 bg-yellow-50 rounded">
        ...
        <ol className="list-decimal pl-5 space-y-2">
          <li>
            First check if the issue is in the debugging tools themselves using{" "}
            <code>/debug/no-debug-tools</code>
          </li>
          <li>
            If that page works normally, examine the debug tool implementations
            for useEffect dependencies
          </li>
          <li>
            Test with different SWR configurations to see if data fetching is
            involved
          </li>
          <li>
            Look at your app&apos;s provider structure - try temporarily
            removing providers one at a time
          </li>
          <li>
            Check for misuse of useState inside render or state updates in
            non-memoized callbacks
          </li>
          <li>
            Review your component tree for circular dependencies between parent
            and child state
          </li>
        </ol>
