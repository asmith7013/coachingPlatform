...
export default function StaffDebugPage() {
  const [activeTab, setActiveTab] = useState<'bisector' | 'real-component' | 'advanced'>('bisector');
          ...
          {wrappedComponent(
            <div className="p-6 bg-white rounded border">
              <p className="text-center text-gray-500">
                ...
                <br />1. Import your NYCPSStaffList component here
                <br />2. Remove this placeholder
                <br />3. Replace with: {`{wrappedComponent(<NYCPSStaffList />)}`}
              </p>
            </div>
          )}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-6 bg-white rounded border">
            ...
            <ol className="list-decimal pl-5 space-y-2">
              <li>First use the Bisector to identify which part causes the loop</li>
              <li>Then use the Live Component tab with debug wrappers</li>
              <li>Check the console for detailed render information</li>
              <li>Look for components rendering multiple times in quick succession</li>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>Ensure SWR configurations prevent unnecessary revalidation</li>
