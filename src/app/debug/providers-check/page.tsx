...
export default function ProvidersCheck() {
  const [activeTest, setActiveTest] = useState<'no-providers' | 'custom-swr' | 'no-perf'>('no-providers');
    ...
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="p-4 border rounded bg-gray-50">
        <h2 className="text-lg font-semibold mb-4">
          Testing {activeTest === 'no-providers' ? 'with no providers' : 
                 activeTest === 'custom-swr' ? 'with custom SWR config' : 
                 'without performance monitoring'}
        </h2>
        
        {activeTest === 'no-providers' && (
          <div>
            <p className="mb-4 text-sm text-gray-600">Running with no providers to establish baseline</p>
        ...
        {activeTest === 'custom-swr' && (
          <div>
            <p className="mb-4 text-sm text-gray-600">Using custom static SWR config that never revalidates</p>
        ...
        {activeTest === 'no-perf' && (
          <div>
            <p className="mb-4 text-sm text-gray-600">Running without performance monitoring hooks</p>
        ...
        <div className="mt-6 text-sm bg-yellow-50 p-3 rounded">
          ...
          <ul className="list-disc pl-5 mt-2">
            <li>If all tests show render loops, the issue is likely in the RenderLoopDetector or core Next.js config</li>
            <li>If only the global app shows loops, check your app&apos;s provider hierarchy</li>
            <li>Specifically check for circular state updates in context providers</li>
