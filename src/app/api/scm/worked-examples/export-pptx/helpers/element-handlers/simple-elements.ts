...
export function addBadge(
  ...
  const bgColor =
    el.bgColor ||
    extractBgColor($("body").children().first().attr("style")) ||
    COLORS["primary"];
  const textColor =
    extractColor($("body").children().first().attr("style")) ||
    TYPOGRAPHY["badge"].color;
...
export function addSubtitle(
  ...
  const $first = $("body").children().first();
  const color =
    extractColor($first.attr("style")) || TYPOGRAPHY["subtitle"].color;
...
export function addFootnote(
  ...
  const $first = $("body").children().first();
  const color =
    extractColor($first.attr("style")) || TYPOGRAPHY["footnote"].color;
 ...
 */
export function addStrategyBadge(
  slide: pptxgen.Slide,
  el: PptxElement,
  x: number,
  y: number,
 ...
 */
export function addStrategyName(
  slide: pptxgen.Slide,
  el: PptxElement,
  x: number,
  y: number,
  ...
  const color =
    extractColor($("body").children().first().attr("style")) ||
    TYPOGRAPHY["strategy-name"].color;
 ...
 */
export function addStrategySummary(
  slide: pptxgen.Slide,
  el: PptxElement,
  x: number,
  y: number,
  ...
  const color =
    extractColor($("body").children().first().attr("style")) ||
    TYPOGRAPHY["strategy-summary"].color;
 ...
 */
export function addVisualArea(
  _slide: pptxgen.Slide,
  _el: PptxElement,
  _x: number,
  _y: number,
  _w: number,
