...
const sampleData: Student[] = [
  { id: '1', name: 'Alice Johnson', grade: 5, subject: 'Math', score: 95, status: 'completed' },
  { id: '2', name: 'Bob Smith', grade: 4, subject: 'Reading', score: 87, status: 'completed' },
  { id: '3', name: 'Carol Davis', grade: 5, subject: 'Math', score: 0, status: 'in-progress' },
]
