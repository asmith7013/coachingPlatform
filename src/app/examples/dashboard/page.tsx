        ...
        <div className="xl:pl-72">
          ...
          <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-6 border-b border-white/5 bg-gray-900 px-4 shadow-xs sm:px-6 lg:px-8">
            <button
              ...
              className="-m-2.5 p-2.5 text-text xl:hidden"
            >
          ...
          <main className="lg:pr-96">
            <header className="flex items-center justify-between border-b border-white/5 px-4 py-4 sm:px-6 sm:py-6 lg:px-8">
              <h1 className="text-base/7 font-semibold text-text">
                Deployments
              </h1>
                ...
                <li key={item.commit} className="px-4 py-4 sm:px-6 lg:px-8">
                  <div className="flex items-center gap-x-3">
                    <Image
                      ...
                      height={32}
                    />
                    <h3 className="flex-auto truncate text-sm/6 font-semibold text-text">
                      {item.user.name}
                    </h3>
                    <time
