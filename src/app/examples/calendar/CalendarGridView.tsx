          ...
          return (
            ...
            >
              <div className="flex justify-between items-start">
                <span
                  className={`text-sm font-medium ${day.isToday ? "h-6 w-6 rounded-full bg-blue-600 text-white flex items-center justify-center" : ""}`}
                >
                  {day.day}
                </span>
                {cycleInfo && (
                  <span
                    className={`text-xs px-2 py-1 rounded ${cycleInfo.name.includes("Winter") ? "bg-blue-100 text-blue-800" : "bg-green-100 text-green-800"}`}
                  >
                ...
                {dayVisits.map((visit) => (
                  ...
                  >
                    ...
                    <div className="flex items-center mt-1">
                      <span
                        className={`w-2 h-2 rounded-full ${deliveryColors[visit.delivery] || "bg-gray-300"} mr-1`}
                      ></span>
