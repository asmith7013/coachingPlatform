...
export const findCycleForDate = (date: Date, cycles: Record<string, { date: string; label: string }[]>): { cycleName: string, cycleDate: { date: string, label: string } } | null => {
...
export const groupVisitsByCycle = (visits: import('./types').Visit[], cycles: Record<string, { date: string; label: string }[]>) => {
