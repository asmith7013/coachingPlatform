...
export default function IPGDashboard() {
  ...
  const selectedObservation = ipgData.find(obs => obs.teacherName === selectedTeacher);

  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">IPG Observation Dashboard</h1>
        ...
        {selectedObservation && (
          <div>
            ...
            <div className="sticky top-0 z-10 bg-white shadow-sm border-b border-gray-200 -mx-4 px-4 py-4 mb-8">
              <h2 className="text-2xl font-semibold text-gray-800">{selectedObservation.teacherName}</h2>
        ...
        {!selectedTeacher && (
          <div className="text-center py-12">
            <p className="text-gray-500 text-lg">Select a teacher to view their IPG observation data</p>
          </div>
        )}
      </div>
    </div>
