    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-6 text-center text-blue-800">
          Coaching Action Plan Examples
        </h1>

        <p className="text-lg mb-8 text-center text-gray-700">
          Explore different coaching action plan templates implemented in our
          platform.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <Link href="/examples/cap/example1" className="block group">
            <div className="border border-gray-200 rounded-lg shadow-sm p-6 transition-all duration-200 hover:shadow-md hover:border-blue-300 h-full">
              ...
              <p className="text-gray-600 mb-4">
                Standard coaching action plan format, organized by stages with
                success metrics and implementation records.
              </p>
          ...
          <Link href="/examples/cap/example2" className="block group">
            <div className="border border-gray-200 rounded-lg shadow-sm p-6 transition-all duration-200 hover:shadow-md hover:border-blue-300 h-full">
              ...
              <h2 className="text-xl font-semibold mb-2 group-hover:text-teal-600">
                NYC Solves Math Format
              </h2>
              <p className="text-gray-600 mb-4">
        ...
        <div className="mt-12 p-6 bg-blue-50 rounded-lg border border-blue-100">
          <h2 className="text-xl font-semibold mb-3 text-blue-800">
            About Coaching Action Plans
          </h2>
          <p className="text-blue-700 mb-4">
            Coaching Action Plans (CAPs) provide a structured approach to
            coaching cycles, ensuring clear goals, aligned metrics, and
            purposeful implementation. These examples showcase different formats
            used by educational organizations to document and track coaching
            engagements.
          </p>
