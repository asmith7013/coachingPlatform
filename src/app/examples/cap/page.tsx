        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <Link href="/examples/cap/example1" className="block group">
            <div className="border border-gray-200 rounded-lg shadow-sm p-6 transition-all duration-200 hover:shadow-md hover:border-blue-300 h-full">
              ...
              <h2 className="text-xl font-semibold mb-2 group-hover:text-blue-600">Standard Format</h2>
              <p className="text-gray-600 mb-4">
                Explore our standard coaching action plan format, organized by stages with success metrics and implementation records.
              </p>
