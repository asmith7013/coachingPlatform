...
import KHData from '@/lib/json/kh-routines.json';
import ILCData from '@/lib/json/ilc-routines.json';
import ILCHSData from '@/lib/json/ilc-hs.json';
...
import { renderKHLesson } from '@/lib/domain/imRoutine/render-KH-lesson';
