...
import { screenshotStudentTasks, type ScreenshotResult } from '../../actions/screenshot-scraper';
      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <p className="text-gray-600 mb-8">
            Enter a list of lesson URLs to screenshot the Student Task Statement section from each page
          </p>
          ...
          {credentials && (
            <div className="mb-8">
              <h2 className="text-xl font-semibold mb-4">Step 2: Enter Lesson URLs</h2>
              <textarea
                value={urls}
