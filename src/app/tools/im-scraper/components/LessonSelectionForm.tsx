...
interface LessonSelectionFormProps {
  ...
  onUrlParamsChange: (
    updater: (
      prev: LessonSelectionFormProps["urlParams"],
    ) => LessonSelectionFormProps["urlParams"],
  ) => void;
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              onUrlParamsChange((prev) => ({
                ...prev,
                startUnit: parseInt(e.target.value),
              }))
            }
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              onUrlParamsChange((prev) => ({
                ...prev,
                endUnit: parseInt(e.target.value),
              }))
            }
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
      ...
      {urlParams.selectedSections.length > 0 && (
        <div className="space-y-4">
          <h4 className="text-md font-medium text-gray-800">
            Select Lessons for Each Section
          </h4>
          {urlParams.selectedSections.map((section) => (
            <LessonSelector
              ...
              onLessonsChange={(lessons) =>
                handleLessonChange(section, lessons)
              }
