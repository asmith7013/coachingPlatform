...
export default function SummerProgramHome() {
  return (
    <div className="p-8">
      <Heading level="h1" color="default" className="text-primary mb-2">
        313 Summer Program Dashboard
      </Heading>
      <Text textSize="lg" color="muted" className="mb-8">
        Welcome to the 313 Summer Program management system. Monitor student
        progress, analyze performance data, and manage curriculum across
        Districts 9 and 11.
      </Text>
        ...
        <Card padding="lg" radius="lg" shadow="md">
          <div className="flex items-center">
            ...
            <div>
              ...
              <Text textSize="2xl" className="font-bold">
                --
              </Text>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card padding="lg" radius="lg" shadow="md">
          ...
          <Text textSize="sm" color="muted" className="mb-4">
            View and manage all summer program students across districts and
            sections.
          </Text>
        ...
        <Card padding="lg" radius="lg" shadow="md">
          ...
          <Text textSize="sm" color="muted" className="mb-4">
            Analyze program performance, student progress, and district
            comparisons.
          </Text>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <Link href="/313/students?district=D9">
              <Button intent="secondary" appearance="outline" textSize="sm">
                View D9 Students
              </Button>
            </Link>
          </Card>
