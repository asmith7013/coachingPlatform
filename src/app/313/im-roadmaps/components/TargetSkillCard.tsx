...
export function TargetSkillCard({
  ...
  return (
    <div
      className={`bg-white rounded-lg shadow-lg border border-gray-200 p-6 mb-6 ${targetSkillStyles.containerClass}`}
    >
      {/* Target Skill Header */}
      <div className="mb-6">
        <div className="flex justify-between items-start mb-4">
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3
                className={`text-xl font-bold text-blue-900 ${targetSkillStyles.textClass}`}
              >
            ...
            <p className={`text-gray-700 mb-3 ${targetSkillStyles.textClass}`}>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="space-y-4">
          ...
          {relatedEssentialSkills.length > 0 ? (
            <div className="space-y-3">
              {relatedEssentialSkills.map((skill, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={`bg-red-50 p-3 rounded-lg border border-red-100 ${skillStyles.containerClass}`}
                  >
                    <div className="flex justify-between items-start mb-2">
                      <div className="flex items-center gap-1 flex-1">
                        ...
                        <h5
                          className={`font-medium text-red-900 text-sm ${skillStyles.textClass}`}
                        >
                          {skill.title}
                        </h5>
                      </div>
                    ...
                    <p
                      className={`text-red-700 text-xs ${skillStyles.textClass}`}
                    >
                      {skill.description}
                    </p>
                    {skill.skillId && (
            ...
            <p className="text-gray-500 text-sm italic">
              No essential prerequisites identified
            </p>
          )}
        </div>
        ...
        <div className="space-y-4">
          ...
          {relatedHelpfulSkills.length > 0 ? (
            <div className="space-y-3">
              {relatedHelpfulSkills.map((skill, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={`bg-green-50 p-3 rounded-lg border border-green-100 ${skillStyles.containerClass}`}
                  >
                    <div className="flex justify-between items-start mb-2">
                      <div className="flex items-center gap-1 flex-1">
                        {skillStyles.indicator && (
                        ...
                        <h5
                          className={`font-medium text-green-900 text-sm ${skillStyles.textClass}`}
                        >
                          {skill.title}
                        </h5>
                      </div>
                    ...
                    <p
                      className={`text-green-700 text-xs ${skillStyles.textClass}`}
                    >
                      {skill.description}
                    </p>
                    {skill.skillId && (
            ...
            <p className="text-gray-500 text-sm italic">
              No helpful supporting skills identified
            </p>
          )}
        </div>
      </div>
