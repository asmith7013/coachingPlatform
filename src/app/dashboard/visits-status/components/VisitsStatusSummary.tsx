...
export function VisitsStatusSummary({
  visits,
  isLoading,
}: VisitsStatusSummaryProps) {
  if (isLoading) {
    return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      <Card>
        <Card.Body className="flex items-center">
          ...
          <div>
            <Heading level="h3" className="text-green-700">
              {completeCount}
            </Heading>
      ...
      <Card>
        <Card.Body className="flex items-center">
          ...
          <div>
            <Heading level="h3" className="text-red-700">
              {incompleteCount}
            </Heading>
      ...
      <Card>
        <Card.Body className="flex items-center">
          ...
          <div>
            <Heading level="h3" className="text-blue-700">
              {scheduledCount}
            </Heading>
