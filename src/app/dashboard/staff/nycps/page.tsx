...
const NYCPSStaffList = memo(function NYCPSStaffListComponent() {
  ...
  const handleSort = useCallback(
    (field: keyof NYCPSStaffInput, order: "asc" | "desc") => {
      if (field === "staffName") {
  ...
  return (
    ...
    >
      <ResourceHeader<NYCPSStaffInput>
        ...
        total={total}
        limit={limit}
        sortOptions={[{ key: "staffName", label: "Name" }]}
        onSort={handleSort}
      ...
      <EmptyListWrapper items={staff || []} resourceName="staff members">
        ...
        {staff && staff.length > 100 ? (
          <div className="virtual-list-warning bg-yellow-50 p-4 rounded mb-4">
            <Text color="accent" className="text-yellow-700">
              Large staff list detected. Consider implementing virtualization
        ...
        >
          <div className="p-4">
            <p className="text-gray-600 mb-4">
              Edit functionality temporarily disabled during form system
              migration.
            </p>
            <div className="space-y-2 text-sm">
              <p>
                <strong>Name:</strong> {editTarget.staffName}
              </p>
              <p>
              ...
              <p>
                ...
                {editTarget.subjects?.join(", ") || "None"}
              </p>
              <p>
                <strong>Roles:</strong>{" "}
                {editTarget.rolesNYCPS?.join(", ") || "None"}
              </p>
            </div>
          </div>
          <Button
