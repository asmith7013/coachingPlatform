    ...
    <div className="mt-6">
      ...
      <div className="space-y-2">
        <div className="flex items-center gap-2">
          ...
          />
          <label htmlFor="checklist-cooldowns" className="text-sm">
            Ask for Cool Downs
          </label>
        </div>
        <div className="flex items-center gap-2">
          ...
          />
          <label htmlFor="checklist-summary" className="text-sm">
            Fill out Visit Summary
          </label>
        </div>
        <div className="flex items-center gap-2">
          <Checkbox
          ...
          />
          <label htmlFor="checklist-stopwatch" className="text-sm">
            Pause stopwatch
          </label>
        </div>
      </div>
