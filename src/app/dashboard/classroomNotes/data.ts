...
export const curriculumData = {
  'Grade 6': {
    units: {
      'Unit 1': { lessons: ['Lesson 1', 'Lesson 2', 'Lesson 3', 'Lesson 4', 'Lesson 5'] },
  ...
  'Algebra 1': {
    units: {
      ...
      'Unit 7': { lessons: ['Lesson 1', 'Lesson 2', 'Lesson 3', 'Lesson 4', 'Lesson 5'] },
    }
  },
  'Algebra 2': {
    units: {
...
export const exampleLessonData = {
  ...
  lessonUrl: 'https://curriculum.illustrativemathematics.org/HS/teachers/1/7/2/index.html'
}; 