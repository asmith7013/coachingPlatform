    ...
    <FormSection title="Input Format">
      ...
      {inputMode === 'text' ? (
        <div>
          ...
          <Text className="text-sm mb-2">Use numbered items (1. 2.) for sections and bullets (*) for tasks</Text>
          <Textarea
        ...
        <div>
          ...
          <Text className="text-sm mb-2">Enter your checklist as a JSON object with the structure shown below</Text>
          <Textarea
            placeholder={`{
  "title": "Project Title",
  "notes": "Project notes",
