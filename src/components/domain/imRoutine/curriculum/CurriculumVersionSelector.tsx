...
export function CurriculumVersionModal({
  onSelectVersion,
}: CurriculumVersionModalProps) {
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl p-10 max-w-xl w-full shadow-xl text-center space-y-6">
        ...
        <p className={cn(typography.textSize.base, "text-muted")}>
          While both use Illustrative Mathematics content,{" "}
          <strong>Kendall Hunt</strong> and <strong>ILC</strong> have different
          routines embedded in their lessons. Please choose the version your
          school uses so this tool can reflect the correct routines.
        </p>
