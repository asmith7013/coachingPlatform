    ...
    <div>
      <div className="flex justify-between items-center mb-4">
        <h3 className="font-semibold text-lg">
          Action Plan - Menu of Coaching Moves
        </h3>
        <Button
          intent="secondary"
          appearance="outline"
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <Input
                ...
                onChange={(e) =>
                  updateMove(index, "specificMove", e.target.value)
                }
              ...
              <Input
                ...
                onChange={(e) =>
                  updateMove(index, "toolsResources", e.target.value)
                }
