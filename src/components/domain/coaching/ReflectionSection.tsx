...
export const ReflectionSection: React.FC<ReflectionSectionProps> = ({
  ...
  return (
    <div className="mt-8">
      ...
      {/* Task 5.7: Spotlight opportunity suggestions based on progress */}
      {showSpotlightSuggestion && (
        <div className="mt-6 bg-green-50 p-4 rounded-lg border border-green-200">
          <h4 className="font-medium text-green-700 mb-2">
            Teacher Spotlight Opportunity
          </h4>
          <p className="text-green-800 mb-3">
            Based on the progress shown in this coaching cycle, consider sharing
            these practices with other teachers through professional development
            or peer learning.
          </p>
