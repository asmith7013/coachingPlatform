...
const teacherDropdown = tv({
  slots: {
    ...
    dropdownIcon: ["mr-3 h-5 w-5 text-gray-400", "group-hover:text-gray-500"],
  },
});
...
export function TeachersCard({
  ...
  const handleTeacherActionClick = (
    e: React.MouseEvent,
    teacher: { _id: string; staffName?: string },
  ) => {
    e.stopPropagation();
              ...
              <div key={teacher._id} className="relative">
                <SimpleCard
                  ...
                  onActionClick={(e: React.MouseEvent) =>
                    handleTeacherActionClick(e, teacher)
                  }
                />
                <TeacherDropdown
