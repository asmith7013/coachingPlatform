...
import {
  ...
  useMondayFilters,
} from "@hooks/integrations/monday/MondayImportContext";
  ...
  const handleImport = async () => {
    try {
      ...
      if (result.success && result.data) {
        ...
        console.log(
          "Import successful, processed visit data:",
          processedVisitData,
        );
        ...
        router.push(
          `/integrations/monday/visits/import/complete?${params.toString()}`,
        );
      } else {
  ...
  if (filteredPreviews.length === 0) {
    return (
      <Alert intent="info" className="mb-4">
        ...
        <Text>
          No visits were found on this Monday.com board. Please select a
          different board or make sure your Monday.com board has data.
        </Text>
      </Alert>
    );
  }
    ...
    <div className="space-y-4">
      ...
      <div className="flex justify-between items-center mb-4">
        <div className="flex items-center space-x-2">
          <Checkbox
            checked={
              selectedItems.length === filteredPreviews.length &&
          ...
          >
            <div className="flex items-start">
              ...
              <div className="flex-1 min-w-0">
                <Heading level="h4" className="mb-1 truncate">
                  {preview.name}
                </Heading>
