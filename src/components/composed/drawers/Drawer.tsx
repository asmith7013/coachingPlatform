...
const drawerVariants = tv({
  slots: {
    ...
    closeButtonInner:
      "relative rounded-md text-gray-400 hover:text-gray-500 focus:ring-2 focus:ring-offset-2 focus:outline-hidden",
    closeIcon: "size-6",
...
function DrawerBody({ children, className }: DrawerBodyProps) {
  ...
  return <div className={cn(variants.body(), className)}>{children}</div>;
}
