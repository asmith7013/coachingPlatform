...
const sectionHeadingVariants = tv({
  ...
  variants: {
    ...
    iconVariant: {
      colored: {
        iconWrapper:
          "size-12 bg-gradient-to-br from-purple-500 to-purple-600 text-white shadow-sm",
      },
      neutral: {
...
const SectionHeading = forwardRef<
  HTMLDivElement,
  SectionHeadingProps & SectionHeadingVariants
    ...
    <div key={index} className="flex">
      ...
      {action.onSort && (
        <button
          ...
          disabled={action.disabled}
        >
          <BarsArrowUpIcon aria-hidden="true" className={styles.sortIcon()} />
