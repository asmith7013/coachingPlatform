...
const teacherScheduleCalendar = tv({
  slots: {
    container: ['flex h-full flex-col overflow-hidden max-w-full', radii.lg],
    header: ['flex flex-none items-center justify-between px-4 md:px-6 py-3 md:py-4', radiiTop.lg],
    title: 'text-sm md:text-base font-semibold text-gray-900',
  ...
  variants: {
    variant: {
      default: {},
      compact: {
        header: 'px-3 md:px-4 py-2 md:py-3',
        title: 'text-xs md:text-sm font-medium',
        ...
        <div className="flex items-center space-x-2 md:space-x-4">
          <div className="flex items-center rounded-md bg-white shadow-sm">
            <button
              ...
              className="flex h-7 w-7 md:h-8 md:w-8 items-center justify-center rounded-l-md border-y border-l border-gray-300 text-gray-400 hover:text-gray-500"
            >
            ...
            <button
              ...
              className="h-7 md:h-8 border-y border-gray-300 px-2 md:px-3 text-xs md:text-sm font-semibold text-gray-900 hover:bg-gray-50 flex items-center justify-center"
            >
              Today
            </button>
            <button
              ...
              className="flex h-7 w-7 md:h-8 md:w-8 items-center justify-center rounded-r-md border-y border-r border-gray-300 text-gray-400 hover:text-gray-500"
            >
