...
const timeGrid = tv({
  slots: {
    ...
    timeLabel:
      "sticky left-0 z-20 -mt-2.5 -ml-14 w-14 pr-2 text-right text-xs/5 text-gray-400",
    verticalLines:
  ...
  return (
    <div className={styles.container()}>
      ...
      <div className={styles.gridContainer()}>
        ...
        >
          <div
            ref={containerRefs.containerOffset}
            className={styles.offsetDiv()}
          />
        ...
        <div className={styles.verticalLines()}>
          {Array.from({ length: 7 }, (_, i) => (
            <div
              key={i}
              className={`col-start-${i + 1} ${styles.verticalLine()}`}
            />
          ))}
