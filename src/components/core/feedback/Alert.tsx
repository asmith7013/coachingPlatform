  ...
  variants: {
    ...
    layout: {
      stacked: {
        ...
        title: responsiveLayoutVariant({
          stack: "always",
          titleSpacing: "normal",
        }).title(),
        description: responsiveLayoutVariant({
          stack: "always",
          contentWidth: "full",
        }).content(),
      },
...
const useAlertContext = () => {
  ...
  if (!context) {
    throw new Error(
      "Alert subcomponents must be used within an Alert component",
    );
  }
  return context;
};
...
>(({ className, ...props }, ref) => {
  ...
  return <h5 ref={ref} className={cn(styles.title(), className)} {...props} />;
});
