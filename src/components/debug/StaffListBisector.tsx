...
const StaticForm = () => (
  <div className="p-4 mt-4 border rounded bg-gray-50">
    ...
    <input
      ...
      disabled
    />
    <button className="p-2 bg-blue-500 text-white rounded" disabled>
      Add
    </button>
  </div>
);
...
export function StaffListBisector() {
  ...
  const content = (() => {
    switch (uiMode) {
      ...
      case "minimal":
        return (
          <div className="p-4 bg-white rounded">Minimal test component</div>
        );
      case "full":
      default:
        return (
