      ...
      <Card.Body className="space-y-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="text-center p-4 bg-green-50 rounded-lg border border-green-200">
            ...
            <Text textSize="sm" color="muted">Present</Text>
          ...
          <div className="text-center p-4 bg-yellow-50 rounded-lg border border-yellow-200">
            ...
            <Text textSize="sm" color="muted">Late</Text>
          ...
          <div className="text-center p-4 bg-red-50 rounded-lg border border-red-200">
            ...
            <Text textSize="sm" color="muted">Absent</Text>
        ...
        {recentAttendance.length > 0 && (
          <div>
            <Heading level="h4" className="mb-3">Recent Days</Heading>
        ...
        <div className="pt-4 border-t">
          <div className="flex justify-between items-center mb-2">
            <Text textSize="sm" className="font-medium">Overall Attendance</Text>
          ...
          <Text textSize="xs" color="muted" className="mt-1">
            {stats.present + stats.late}% attendance rate (including late arrivals)
          </Text>
        </div>
      </Card.Body>
    </Card>
