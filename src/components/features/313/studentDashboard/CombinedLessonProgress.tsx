...
import {
  useCombinedLessonData,
  type CombinedLessonStatus,
} from "@/hooks/domain/313/useCombinedLessonData";
import {
  StudentData,
  getSectionType,
} from "@/lib/schema/zod-schema/scm/student/student-data";
...
export function CombinedLessonProgress({
  studentData,
}: CombinedLessonProgressProps) {
