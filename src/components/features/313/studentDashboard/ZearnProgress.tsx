  ...
  return (
    <Card>
      <Card.Header>
        ...
        <Text color="secondary">Latest lesson completions and time spent</Text>
      </Card.Header>

      <Card.Body className="space-y-4">
        {/* Recent lessons completed */}
        <div>
          <Text textSize="sm" className="font-medium mb-2">
            Recent Lessons Mastered:
          </Text>
