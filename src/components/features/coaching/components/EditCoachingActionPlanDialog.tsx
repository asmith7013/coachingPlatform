      ...
      try {
        ...
        setError(
          error instanceof Error
            ? error.message
            : "Failed to update coaching action plan",
        );
      }
    },
      ...
      <Dialog open={open} onClose={handleClose} size="md">
        <div className="p-6 text-center">
          ...
          <p className="text-sm text-gray-600">
            Please wait while we load the coaching action plan.
          </p>
        </div>
      </Dialog>
    );
      ...
      <div className="p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              Update plan details and information
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="mt-2">
              <input
                ...
                className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                value={
                  (formData.startDate as Date | string | undefined)
                    ? new Date(formData.startDate as Date | string)
                        .toISOString()
                        .split("T")[0]
                    : ""
                }
          ...
          <div>
            ...
            <div className="mt-2">
              <input
                ...
                className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                value={
                  (formData.endDate as Date | string | undefined)
                    ? new Date(formData.endDate as Date | string)
                        .toISOString()
                        .split("T")[0]
                    : ""
                }
          ...
          <div className="flex justify-end gap-3 mt-6 pt-4 border-t border-gray-200">
            ...
            <Button intent="primary" type="submit" loading={isUpdating}>
              Save Changes
            </Button>
          </div>
        </form>
