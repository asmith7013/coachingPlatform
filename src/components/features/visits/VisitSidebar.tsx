...
const visitSidebar = tv({
  slots: {
    ...
    listItem: 'flex items-center justify-between py-2 border-b border-gray-100 last:border-0',
      ...
      <div className={styles.section()}>
        ...
        <div className="space-y-3">
          <div>
            ...
            <p className="text-sm text-gray-900 mt-1">{visit.allowedPurpose || 'Visit'}</p>
          </div>
          <div>
            <span className="text-xs font-medium text-gray-500 uppercase tracking-wide">Mode</span>
            <p className="text-sm text-gray-900 mt-1">{visit.modeDone || 'In-person'}</p>
          </div>
          <div>
            <span className="text-xs font-medium text-gray-500 uppercase tracking-wide">Grade Levels</span>
