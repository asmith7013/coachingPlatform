...
const rubricLookFors: RubricLookFor[] = [
  {
    ...
    levels: [
      ...
      { value: 2, label: 'Approaching', description: 'Some students are engaged' },
      { value: 3, label: 'Meeting', description: 'Most students are engaged' },
      { value: 4, label: 'Exceeding', description: 'All students are highly engaged' },
    ],
  },
  {
    id: '2',
    ...
    levels: [
      { value: 1, label: 'Not Yet', description: 'Instruction is not effective' },
      { value: 2, label: 'Approaching', description: 'Instruction is somewhat effective' },
      { value: 3, label: 'Meeting', description: 'Instruction is effective' },
      { value: 4, label: 'Exceeding', description: 'Instruction is highly effective' },
    ],
  },
];
...
export function ScoresPage() {
  ...
  const schoolOptions = schools
    .filter(school => !selectedDistrict || school.districtId === selectedDistrict)
