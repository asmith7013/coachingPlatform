...
import type { EventSegment } from '@/components/features/scheduleBuilder/types'
import { getSegmentsForPeriod } from '@/components/features/scheduleBuilder/transformers/schedule-transforms'
