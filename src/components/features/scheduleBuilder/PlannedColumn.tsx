...
import type { PlannedColumnProps } from './types'
import type { HoverZone, ScheduleAssignmentType, DropZone } from '@lib/types/domain/schedule'
import { AssignedTeacherCard } from '@/components/features/scheduleBuilder/AssignedTeacherCard'
