...
export const queryKeys = {
  ...
  monday: {
    ...
    potentialVisits: (boardId: string) =>
      [...queryKeys.monday.board(boardId), "potential"] as const,
    importPreview: (ids: string[]) =>
      [...queryKeys.monday.visits(), "preview", ids.join(",")] as const,
  },
  ...
  ui: {
    all: ["ui"] as const,
    filters: (screen: string) =>
      [...queryKeys.ui.all, "filters", screen] as const,
    pagination: (screen: string) =>
      [...queryKeys.ui.all, "pagination", screen] as const,
  },
