...
import { ResponseTransformer, useQueryPagination } from '@query/client/hooks/core/useQueryPagination';
...
export function useEntityList<T extends BaseDocument, R extends Record<string, unknown> = T>({
  ...
  queryOptions = {},
  errorContextPrefix
}: UseEntityListConfig<T>): ReturnType<typeof useQueryPagination<T, R>> {
