...
/**
 * Bell Schedule entity with Date objects instead of string dates
 */
export type BellScheduleWithDates = WithDateObjects<BellSchedule>;

/**
 * Input type that satisfies DocumentInput constraint
 */
export type BellScheduleInputType = DocumentInput<BellSchedule>;
...
} = createEntityHooks<BellScheduleWithDates, BellScheduleInputType>({
  entityType: 'bellSchedules',
  fullSchema: BellScheduleZodSchema as z.ZodType<BellScheduleWithDates>,
